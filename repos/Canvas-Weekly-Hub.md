...
- **📂 课件自动下载**：新上传的 PPT/PDF 按课程归档到本地
- **📅 日历订阅 / ⬇️ 离线单文件**：截止时间导入手机日历（截止前 2 小时提醒）；一键下载「我的学习网站.html」离线查看
- **🔍 跨周搜索 · 🗓 历史归档 · 🌗 深色模式**

隐私优先：令牌与课程数据只保存在你自己的设备（或你自己的 Cloudflare 账号）中，本项目不设中心服务器；MIT 开源，文档与界面均为中文。
