...
export const PARSER_ROOT = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..');
export const PROJECT_ROOT = path.resolve(PARSER_ROOT, '..');
...
export function loadConfig(overrides = {}) {
  loadEnvFile(path.join(PARSER_ROOT, '.env'));
  return {
